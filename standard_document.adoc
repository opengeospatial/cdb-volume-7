:Title: Volume 7: OGC CDB Data Model Guidance (Best Practice)
:titletext: Volume 7: OGC CDB Data Model Guidance (Best Practice)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
include::clause_6_data_model_guidance.adoc[]
