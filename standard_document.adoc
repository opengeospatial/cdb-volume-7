...
|External identifier of this OGC(R) document:  http://www.opengis.net/doc/BP/CDB-model-guidance/1.3
|Internal reference number of this OGC(R) document:        16-010r6
|Version: 1.2
