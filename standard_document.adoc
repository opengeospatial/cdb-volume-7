...
:titletext: Volume 7: OGC CDB Data Model Guidance, Formerly Annex A Volume Part 2
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document:  http://www.opengis.net/doc/BP/CDB-model-guidance/1.1
...
|Internal reference number of this OGC(R) document:        16-010r4
|Version: 1.1
